...
namespace DuiLib
{
	...
	CEditExUI::CEditExUI() : m_pWindow(NULL), m_uMaxChar(255), m_bReadOnly(false),
	...
	void CListWnd::Init(std::vector<std::string>& itemlist)
	{
	...
	LPCTSTR CListWnd::GetSuperClassName() const
	{
